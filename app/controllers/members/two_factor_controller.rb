...
module Members
  class TwoFactorController < ApplicationController
    ...
    def new
      redirect_to edit_two_factor_path if current_member.otp_secret_key.present?
    end
    ...
    def update
      if current_member.authenticate_otp(two_factor_params[:code])
        ...
        redirect_back fallback_location: two_factor_path, error: "Authentication code mismatch, please try again"
      end
    end
